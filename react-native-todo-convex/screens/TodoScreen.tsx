...
const TodoScreen = () => {
  ...
  // ✅ FIXED toggle (only pass id)
  const toggleTodo = (id: Id<"todos">) => {
...
const styles = StyleSheet.create({
  ...
  searchBar: { flex: 1, height: 50, marginLeft: 10 },
  ...
  textWrapper: { flexDirection: "row", alignItems: "center", flex: 1 },
  todoText: { fontSize: 16, color: "#333", marginLeft: 12 },
  todoCompleted: { textDecorationLine: "line-through", color: "#AAA" },
